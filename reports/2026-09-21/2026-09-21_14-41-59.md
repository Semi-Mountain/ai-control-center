...
报告已写入,虽然大概率不会真正送达,但是按要求执行了。现在给出最终响应。
...
**成交活跃度**:两市半日成交约 **1.5万亿**,与近期持平。

### 板块结构特征
**领涨方向**:
- **地产板块**:300地产 +6.77%、内地地产 +5.41%
- **医药板块**:CS精准医 +4.62%、800医药 +3.69%、细分医药 +3.63%
- **能源板块**:380能源 +3.36%
- **科创生物**:+3.88%
...
**报告路径**:/root/.hermes/cron/output/a62eb8ee37a9/report_20260921_1430.md
