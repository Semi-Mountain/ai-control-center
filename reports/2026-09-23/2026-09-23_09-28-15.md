...
报告与数据都已保存。任务完成，下面输出飞书消息正文。

---

# ⏰ A股早盘集合竞价扫描 | 2026-09-23 09:27 北京时间

> 📅 **交易日: 2026-09-23 周三** | ✅ **数据源: 腾讯财经**（akshare 连接失败，已自动切换）  
> 🎯 **监控: 3只持仓股 + 三大指数集合竞价**
...
| 指数 | 开盘点位 | 涨跌幅 | 走势 |
|------|---------|--------|------|
| 上证指数 | 3951.37 | **-0.02%** | 📉 微跌 |
| 深证成指 | 13742.55 | **+0.14%** | 📈 |
| 创业板指 | 3412.53 | **+0.37%** | 📈 |

**大盘研判**: 三大指数分化，深强沪弱格局。创业板领涨 +0.37%，市场情绪中性偏暖。警惕高开低走，盯紧 9:30 后首根 30 分钟 K 线。
...
| 指标 | 数值 |
|------|------|
| 昨收 → 今开 | 107.09 → **107.14**（+0.05%） |
| 集合竞价量 | 2,531 手 / 2712 万 |
| 5日趋势 | +9.29%（强势股） |

**信号**: 等方向选择  
**建议**: 持有观望。放量破 107.5继续持有；跌破 107 减仓 1/3

### 📉 北部湾港(000582) — 小低开 ⚠️

| 指标 | 数值 |
|------|------|
| 昨收 → 今开 | 9.78 → **9.71**（-0.72%） |
| 集合竞价量 | 1,793 手 / 174 万 |
| 5日趋势 | -12.0%（走弱） |

**信号**: 需观察承接力度  
**建议**: ⚠️ **止损位 9.55（昨收 -2.4%）**，跌破减仓一半；若开盘后收回 9.78 站稳则继续持有

### ➡️ 中国卫星(600118) — 平开

| 指标 | 数值 |
|------|------|
| 昨收 → 今开 | 58.82 → **58.89**（+0.12%） |
| 集合竞价量 | 562 手 / 331 万 |
| 5日趋势 | +2.79%（健康） |
...
| 操作 | 说明 |
|------|------|
| 🚫 **不加仓** | 早盘竞价信号混合，无明确买入信号 |
| ⚠️ **北部湾港重点盯** | 跌破 9.55 执行止损 |
| ✅ **华工/卫星** | 持有，等待 9:30 方向明确 |

---

## 五、风险预警

⚠️ **数据源切换**: akshare 失败，已自动切换腾讯财经（数据精度略低）  
⚠️ **9:30 关键窗口**: 首根 30 分钟 K 线才是真实决策依据，请 9:30-10:00 重点盯盘  
⚠️ **结构性行情**: 今日深强沪弱，关注创业板持续性

---

**📁 报告保存路径**: `~/.hermes/cron/output/ac7c3adeb89b/auction_report_20260923_0927.md`  
**📊 面板同步**: ✅ 已同步行情数据到 `quotes.json`
