...
# 📊 A股每日盘中小结 - 2026-09-23（周三）

**生成时间**: 2026-09-23 11:30 北京时间  
**交易日**: ✅ 是 | **任务ID**: df86155a683d
...
| 指数 | 现价 | 涨跌幅 | 涨跌额 |
|------|------|--------|--------|
| 上证指数 | 3938.08 | -0.36% | -14.05 |
| 深证成指 | 13644.72 | -0.58% | -79.02 |
| 创业板指 | 3385.30 | -0.43% | -14.63 |
| 沪深300 | 4521.75 | -0.50% | -22.84 |
| 科创50 | 1662.98 | -0.12% | -2.06 |
| 中证500 | 7799.35 | -0.38% | -29.59 |
| 北证50 | 1069.72 | **+2.19%** | +22.92 |

**📌 整体判断**: 弱势调整，三大指数小幅回调，科创50相对抗跌，北证50独立走强。

---

## 二、涨停跌停统计

- **涨停池**: 37只（防御性板块领涨：出版、家居、纺织）
- **跌停池**: 8只（恐慌情绪减弱）
- **强势股池**: 242只

**连板龙头**: 大亚圣象/新华文轩（4连板）、泰慕士/新华传媒/南威软件/我爱我家/奥佳华/华远控股（3连板）

**📌 板块特征**: 缺乏主线热点，防御性板块（家居、出版）成避风港，赚钱效应一般。

---

## 三、💼 持仓股票表现

| 代码 | 名称 | 现价 | 涨跌幅 | 持仓 | 市值 | 盈亏 | 盈亏% |
|------|------|------|--------|------|------|------|-------|
| 000988 | 华工科技 | 106.15 | -0.88% | 4200 | 445,830 | +296,730 | **+199.01%** |
| 600118 | 中国卫通 | 57.78 | -1.77% | 3000 | 173,340 | +106,440 | **+159.10%** |
| 000582 | 北部湾港 | 9.49 | -2.97% | 5000 | 47,450 | -1,550 | **-3.16%** |

**持仓汇总**: 总市值 **666,620元**，总盈亏 **+401,620元 (+151.55%)**，今日浮亏约 **-9,775元 (-1.45%)**

---

## 四、🔍 个股详细分析

### 1️⃣ 华工科技（000988）- 激光/光通信 ✅ 持有观望
- 午盘-0.88%，守稳106元
- 光通信板块短期走弱，科创50抗跌（-0.12%）
- 关键价位：支撑105元，压力108元

### 2️⃣ 中国卫通（600118）- 卫星/通信 ✅ 持有
- 午盘-1.77%，回踩5日线
- 卫星互联网仍有政策催化
- 关键价位：支撑56.5元，压力59元

### 3️⃣ 北部湾港（000582）- 港口/物流 ⚠️ 重点关注
- 午盘-2.97%，**已破成本价**
- 港口股明显走弱，受外贸/油价波动影响
- **关键支撑9.40元**：守稳可继续持有，破位需止损
...
|--------|------|------|
| 🟢 高 | 维持现有持仓，不追高 | 全部 |
| 🟡 中 | 关注北部湾港9.40元支撑 | 000582 |
| 🟡 中 | 中国卫通下午若企稳可继续持有 | 600118 |
| 🔴 低 | 大盘未企稳前**不建议加仓** | - |

**下午关注节点**：
- 13:30-14:00 大盘是否企稳反弹
- 14:00-14:30 尾盘是否有资金进场
- 14:50 集合竞价判断次日开盘方向
...
1. 市场情绪：缺主线热点，板块轮动快
2. 成交量：午盘成交萎缩，需警惕午后变盘
3. 外围市场：关注人民币汇率、美股期货
4. 持仓结构：科技股占92.6%，行业集中度高

---

## 七、数据源说明（5层fallback生效）

| 数据源 | 状态 | 用途 |
|--------|------|------|
| ✅ tencent-stock-data | 成功 | 实时行情（指数+持仓股）|
| ✅ akshare（部分） | 成功 | 涨停池/跌停池/强势股 |
| ✅ baostock-data | 成功 | 历史K线（备用） |
| ❌ akshare指数/板块/资金流 | 失败 | RemoteDisconnected超时 |

---

## 📁 输出文件

- `~/.hermes/cron/output/df86155a683d/midday_report_2026-09-23.md` ✅
- `~/.hermes/cron/output/df86155a683d/midday_report_2026-09-23.json` ✅
- 面板同步：✅ 学习报告16份+行情报告30份
